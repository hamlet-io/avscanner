...
ARCHIVE_BUCKET_VALID_DIR = os.environ['ARCHIVE_BUCKET_VALID_DIR']
ARCHIVE_BUCKET_INVALID_DIR = os.environ['ARCHIVE_BUCKET_INVALID_DIR']
ARCHIVE_BUCKET_COMPRESSED_DIR = os.environ['ARCHIVE_BUCKET_COMPRESSED_DIR']
